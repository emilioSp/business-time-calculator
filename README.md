...
Business Time Calculator is a simple tool to calculate the business time between two dates, with zero dependencies.
It uses Temporal to compute times.
